...
if __name__ == '__main__':
    # train_txt_path = r'D:\黑马python+ai\53-黑马程序员-2025年python人工智能开发 V6.5\阶段九\009 大模型开发基础与项目-V5.0-AI版\03-code\KidMed-qwen2.5\data\medical_train.txt'
    train_txt_path = r'/KidMed-qwen2.5\data\medical_valid.txt'
    train_pkl_path = r'/KidMed-qwen2.5\data\medical_valid_1.pkl'
